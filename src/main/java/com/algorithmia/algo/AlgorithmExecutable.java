 ...
 */
public final class AlgorithmExecutable {
    ...
    public AlgorithmExecutable(HttpClient client, AlgorithmRef algoRef) {
        this(client, algoRef, new HashMap<String, String>());
    }

    public AlgorithmExecutable(HttpClient client, AlgorithmRef algoRef, Map<String, String> options) {
        this.client = client;
    ...
    public AlgorithmExecutable setOptions(Map<String, String> options) {
        if (options != null) {
            return new AlgorithmExecutable(client, algoRef, new HashMap<String, String>(options));
        }
        return new AlgorithmExecutable(client, algoRef, new HashMap<String, String>());
    }

    public AlgorithmExecutable setOption(String key, String value) {
        Map<String, String> optionsClone = new HashMap<String, String>(options);
        optionsClone.put(key, value);
        return new AlgorithmExecutable(client, algoRef, optionsClone);
    }

    public AlgorithmExecutable setTimeout(Long timeout, TimeUnit unit) {
    ...
    public AlgorithmExecutable setStdout(boolean showStdout) {
        Map<String, String> optionsClone = new HashMap<String, String>(options);
        optionsClone.put(AlgorithmOptions.STDOUT.toString(), Boolean.toString(showStdout));
        return new AlgorithmExecutable(client, algoRef, optionsClone);
    }

    public AlgorithmExecutable setOutputType(AlgorithmOutputType outputType) {
        Map<String, String> optionsClone = new HashMap<String, String>(options);
